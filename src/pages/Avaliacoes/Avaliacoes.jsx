...
const Avaliacoes = () => {
  ...
  const data = [
    ...
    {
      name: `Juliane Vóvio`,
      review: `Sabe uma pessoa iluminada, uma pessoa radiante e que te faz sentir igual, essa é a Lu, trabalho dela é maravilhoso, trata super bem seus pacientes, recomendo demais... Parabéns pelo lindo trabalho.`,
